...
from .derivative import NormalDerivative, shDerivative
...
def denseJointExpJacobian(param, idCoef, texCoef, img, target, model, renderObj, w = (1, 1, 1), randomFacesNum = None):
    ...
    # Shape derivative
    # Use per face normal which easier to differntiate
    ...
    # drid = 2
    # fid = pixelFaces[0]
    # nd = NormalDerivative(vertexCoord, model, Jlan, fid, drid)
    # shnd = shDerivative(faceNorms[fid, 0], faceNorms[fid, 1], faceNorms[fid, 2], nd[0], nd[1], nd[2])
    # print(shnd)
    # print(zzz[:, 0, drid])
    ...
    # # Test dot product
    # print(np.dot(shCoef[:, 0], shnd))
    # print(lll[0, fid, drid])

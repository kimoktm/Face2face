...
class MeshModel:
    ...
    def __init__(self, modelFile, numIdEvecs = 80, numExpEvecs = 78, numTexEvecs = 80):
        ...
        if model == 'bfm2017':
            ...
            self.sourceKimo = np.array([16203, 16235, 16260, 16290, 27061, 22481, 22451, 22426, 22394, 8134, 8143, 8151, 8156, 6986, 7695, 8167, 8639, 9346, 2345, 4146, 5180, 6214, 4932, 4158, 10009, 11032, 12061, 13872, 12073, 11299, 5264, 6280, 7472, 8180, 8888, 10075, 11115, 9260, 8553, 8199, 7845, 7136, 7600, 8190, 8780, 8545, 8191, 7837, 4538, 11679])
